...
- [Donation](#donation)
- [Creation, modification, correction TCL sur mesure](#creation-modification-correction-tcl-sur-mesure)
...
- [Mes realisations](#mes-realisations)
  - [Mes Scripts TCL (exhaustif) :](#mes-scripts-tcl-exhaustif-)
    - [TCL-Youtube-Link <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-youtube-link-freegratuitdonation)
    - [TCL-DictionaryAPI <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-dictionaryapi-freegratuitdonation)
    - [TCL-ClaraServ <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-claraserv-freegratuitdonation)
    - [TCL-SCRIPT-MANAGER Aka TSM <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-script-manager-aka-tsm-freegratuitdonation)
    - [TCL-ReplicaServ-Service <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-replicaserv-service-freegratuitdonation)
    - [TCL-PROXYCHECK <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-proxycheck-freegratuitdonation)
    - [TCL-MOCKS <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-mocks-freegratuitdonation)
    - [TCL-EvaServ <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-evaserv-freegratuitdonation)
    - [TCL-UJL Aka Unrealircd Json Logs <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-ujl-aka-unrealircd-json-logs-freegratuitdonation)
    - [TCL-SHOWINFO <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-showinfo-freegratuitdonation)
    - [TCL_Exec <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl_exec-freegratuitdonation)
    - [TCL-DebugLoader <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-debugloader-freegratuitdonation)
    - [TCL-AuthIRC <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-authirc-freegratuitdonation)
    - [TCL-ZCT Aka **Z**arTek-**C**reole **T**oolkit <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-zct-aka-zartek-creole-toolkit-freegratuitdonation)
    - [fix.eggdrop.cmd.tcl <span style="color:green">(Free/Gratuit/Donation)</span>](#fixeggdropcmdtcl-freegratuitdonation)
    - [tcl-echo-scripts <span style="color:red">(Privée/Payant/Donation)</span>](#tcl-echo-scripts-privéepayantdonation)
    - [TCL-BYPASS-WHO-BLOCKED <span style="color:red">(Privée/Payant/Donation)</span>](#tcl-bypass-who-blocked-privéepayantdonation)
  - [Mes Packages TCL (exhaustif) :](#mes-packages-tcl-exhaustif-)
    - [TCL-PKG-IRCC Aka **IRC C**lient <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-pkg-ircc-aka-irc-client-freegratuitdonation)
    - [TCL-PKG-IRCServices <span style="color:green">(Free/Gratuit/Donation)</span>](#tcl-pkg-ircservices-freegratuitdonation)
    - [TCL-PKG-cbFTPtcl <span style="color:red">(Privée/Payant/Donation)</span>](#tcl-pkg-cbftptcl-privéepayantdonation)
  - [Mes powershell (exhaustif) :](#mes-powershell-exhaustif-)
    - [POWERSHELL-WinSCP-PORTABLE-FR-UPDATE <span style="color:green">(Free/Gratuit/Donation)</span>](#powershell-winscp-portable-fr-update-freegratuitdonation)
  - [Mes Images Docker :](#mes-images-docker-)
    - [EggNet-Docker <span style="color:green">(Free/Gratuit/Donation)</span>](#eggnet-docker-freegratuitdonation)
    - [docker-unrealircd <span style="color:red">(Privée/Payant/Donation)</span>](#docker-unrealircd-privéepayantdonation)
  - [Mes script shell/bash](#mes-script-shellbash)
    - [slTools <span style="color:green">(Free/Gratuit/Donation)</span>](#sltools-freegratuitdonation)
    - [glftpd-installer <span style="color:green">(Free/Gratuit/Donation)</span>](#glftpd-installer-freegratuitdonation)
    - [eggdrop-tools <span style="color:green">(Free/Gratuit/Donation)</span>](#eggdrop-tools-freegratuitdonation)
  - [Mes mIRC scripts](#mes-mirc-scripts)
    - [mirc-script-znc <span style="color:green">(Free/Gratuit/Donation)</span>](#mirc-script-znc-freegratuitdonation)
- [Mes Node JS](#mes-node-js)
    - [BelDocRipper <span style="color:red">(Privée/Payant/Donation)</span>](#beldocripper-privéepayantdonation)
  - [Mes scripts Python](#mes-scripts-python)
    - [slFTP_Admin <span style="color:red">(Privée/Payant/Donation)</span>](#slftp_admin-privéepayantdonation)
  - [Pour glFTPd & [pzs-ng](https://github.com/pzs-ng/pzs-ng)  <span style="color:green">(Free/Gratuit/Donation)</span>:](#pour-glftpd--pzs-ng--freegratuitdonation)
...
### [TCL-DebugLoader](https://github.com/ZarTek-Creole/TCL-DebugLoader) <span style="color:green">(Free/Gratuit/Donation)</span>
...
### [TCL-AuthIRC](https://github.com/ZarTek-Creole/TCL-AuthIRC) <span style="color:green">(Free/Gratuit/Donation)</span>
...
### [EggNet-Docker](https://github.com/ZarTek-Creole/EggNet-Docker) <span style="color:green">(Free/Gratuit/Donation)</span>
...
### [eggdrop-tools](https://github.com/ZarTek-Creole/eggdrop-tools) <span style="color:green">(Free/Gratuit/Donation)</span>
...
## Pour [glFTPd](https://glftpd.io/) et [pzs-ng](https://github.com/pzs-ng/pzs-ng) <span style="color:green">(Free/Gratuit/Donation)</span>:
